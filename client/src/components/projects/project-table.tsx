            ...
            {projects.map((project) => (
              <tr key={project.id} className="border-b border-border-secondary">
                ...
                <td className="p-2 lg:p-4 hidden lg:table-cell">
                  <span 
                    className={`font-semibold text-sm ${(project.profitMargin || 0) >= 60 ? 'text-success' : (project.profitMargin || 0) >= 40 ? 'text-warning' : 'text-error'}`}
                ...
                <td className="p-2 lg:p-4 hidden md:table-cell">
                  <span 
                    className={`text-xs lg:text-sm ${isOverdue(project.dueDate) ? 'text-error' : 'text-text-secondary'}`}
                ...
                <td className="p-2 lg:p-4">
                  <div className="flex space-x-1 lg:space-x-2">
                    ...
                    <button 
                      ...
                      className="text-warning p-1 hidden sm:block"
