      ...
      <main className="flex-1 p-3 lg:p-6 overflow-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 mb-4 lg:mb-6">
          <div className="kpi-card rounded-xl p-6">
            ...
            <div className="text-2xl font-bold text-chart-2 mb-1" data-testid="kpi-profit-margin">
          ...
          <div className="kpi-card rounded-xl p-6">
            ...
            <div className="text-2xl font-bold text-chart-3 mb-1" data-testid="kpi-forecast-accuracy">
              {forecastAccuracy}%
            </div>
