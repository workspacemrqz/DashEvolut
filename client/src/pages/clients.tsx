      ...
      <main className="flex-1 p-3 lg:p-6 overflow-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-6 mb-4 lg:mb-6">
          <div className="kpi-card rounded-xl p-6">
            ...
            <div className="text-3xl font-bold text-success mb-2" data-testid="stat-active-clients">
              {activeClients}
            </div>
          ...
          <div className="kpi-card rounded-xl p-6">
            ...
            <div className="text-3xl font-bold text-warning mb-2" data-testid="stat-prospects">
              {prospects}
            </div>
          ...
          <div className="kpi-card rounded-xl p-6">
            ...
            <div className="text-3xl font-bold text-info mb-2" data-testid="stat-avg-nps">
              {avgNps.toFixed(1)}
            </div>
